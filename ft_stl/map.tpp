...
__FT_CONTAINERS_BEGIN_NAMESPACE
    ...
    public:
         ...
         * that prevented the insertion) and a bool value map to true if and only if the insertion took place.*/
 ...
 * in lhs compares equal with the element in rhs at the same position.*/
    ...
    template< class Key, class T, class Compare, class Allocator >
    inline bool operator!=( ft::map< Key, T, Compare, Allocator >& lhs,
                            ft::map< Key, T, Compare, Allocator >& rhs ){ return !(lhs == rhs); };
 ...
 * by a function equivalent to std::lexicographical_compare.*/
    ...
    template< class Key, class T, class Compare, class Allocator >
    inline bool operator<=( ft::map< Key, T, Compare, Allocator >& lhs,
                            ft::map< Key, T, Compare, Allocator >& rhs ) { return !(rhs < lhs); };
